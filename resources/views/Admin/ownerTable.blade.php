                                ...
                                <table class="table table-hover table-striped">
                                    ...
                                    @foreach ($users as $user)
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('owner.destroy',$user->users_id)}}" type="submit"  class="btn" type="submit" method="post" name="_method" value="delete"><i class="fa fa-trash"></i> Trash</button></td></a>
                                        </tr>
                                         @endforeach
