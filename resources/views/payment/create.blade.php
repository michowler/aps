                        ...
                        <div class="card">
                            ...
                            <div class="w3-container">
                                ...
                                <div class="w3-panel w3-green w3-display-container">
                                    <span onclick="this.parentElement.style.display='none'" class="w3-button w3-green w3-large w3-display-topright">&items;</span>
                                    <p>{!!$message!!}</p>
                                </div>
                        ...
                        <div class="col-md-8">
                                ...
                                <div class="content">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="hidden" name="amount" id="amount" type="text" value="100">
                                        </div>
